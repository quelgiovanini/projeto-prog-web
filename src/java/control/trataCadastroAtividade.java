...
@WebServlet(name = "trataCadastroAtividade", urlPatterns = {"/trataCadastroAtividade"})
public class trataCadastroAtividade extends HttpServlet {
...
//        conexao = DriverManager.getConnection(url, user, senha);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        new AtividadeDAO().inserir(ativ);
            ...
            out.println();
            out.println("<html><head><title> .:: SIATICO ::. </title></head>");
            out.println("<body>");
